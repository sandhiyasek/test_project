...
@Service
public interface INLEPReportManager {
	//Indicator Zone
	...
	public JSONArray getNLEPIndicatorList(int directorateId,String indicatorCategory,int year,String month,String loggedUser);
