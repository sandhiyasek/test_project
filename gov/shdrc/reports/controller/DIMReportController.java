...
import gov.shdrc.reports.service.IDIMReportManager;
...
@Controller
public class DIMReportController {
	@Autowired(required=true)
	IDIMReportManager dimReportManager;
	@Autowired(required=true)
	ICommonReportManager commonReportManager;
	
	@RequestMapping(value="/dimDashboardZone", method=RequestMethod.GET)
	public ModelAndView onLoadDashboardZone(HttpServletRequest request) throws SHDRCException, JSONException, IOException{
		int directorateId=Integer.parseInt(request.getParameter("directorateId"));		
		 ...
		 UserInfo.hasValidReportAccess(ShdrcConstants.Role.DIM);
		 String indicatorCategory="Monthly";
		 CommonStringList commonsList=dimReportManager.getDashboardIntMaxMonthAndYear(directorateId, indicatorCategory);
		 int year=commonsList.getId();
		 String month=commonsList.getName();
		 String loggedUser=UserInfo.getLoggedInUserName();
		 JSONArray indJsonArray=dimReportManager.getDIMIndicatorList(directorateId, indicatorCategory, year, month, loggedUser);
		 ...
		 modelAndView.setViewName("dimDashboardZone");
	return modelAndView;
		
	}
	@RequestMapping(value="/dimReportZone", method=RequestMethod.GET)
	...
	{	
		...
		try{
			...
			UserInfo.hasValidReportAccess(ShdrcConstants.Role.DIM);
			modelAndView.setViewName("dimReportZone");
			...
			reportName="Number of In-Patient Treated";
			...
			modelAndView.addObject("reportZoneData", dimReportManager.getReportZoneData(directorateId,reportName,fromYear,fromMonth,toYear,toMonth,userName));
		}finally{
			monthsList=null;	
			yearList=null;
		}
	...
	@RequestMapping(value="/dimReportZoneSearchChange", method=RequestMethod.POST)
	public @ResponseBody void getcorrespondingMonthData(HttpServletRequest request,HttpServletResponse response) throws SHDRCException, JSONException, IOException{
		...
		monthReportData =  dimReportManager.getReportZoneData(directorateId,reportName,fromYear,fromMonth,toYear,toMonth,userName);
		out.println(monthReportData);
	}
	
	@RequestMapping(value="/dimAnalysisZone", method=RequestMethod.GET)
	public ModelAndView onLoadAnalysisZone(HttpServletRequest request) throws SHDRCException, JSONException, IOException{
		...
		try{
			modelAndView=new ModelAndView();
			UserInfo.hasValidReportAccess(ShdrcConstants.Role.DIM);
			modelAndView.setViewName("dimAnalysisZone");
			...
			analysisReport1 = "Bottom 10 In-Patient Treated District";
			analysisReport2 = "Bottom 10 Out-Patient Treated District";
			analysisReport3 = "Top 10 In-Patient Treated District";
			analysisReport4 = "Top 10 Out-Patient Treated District";
			...
			JSONArray analysisZoneReport1Data= dimReportManager.getAnalysisZoneData(directorateId,analysisReport1,year,month,userName);
			JSONArray analysisZoneReport2Data= dimReportManager.getAnalysisZoneData(directorateId,analysisReport2,year,month,userName);
			JSONArray analysisZoneReport3Data= dimReportManager.getAnalysisZoneData(directorateId,analysisReport3,year,month,userName);
			JSONArray analysisZoneReport4Data= dimReportManager.getAnalysisZoneData(directorateId,analysisReport4,year,month,userName);
	...
	@RequestMapping(value="/dimAnalysisZoneSearchChange", method=RequestMethod.POST)
	...
	@RequestMapping(value="/dimIndicatorZone", method=RequestMethod.GET)
	public ModelAndView dimOnLoadIndicatorZone(HttpServletRequest request) throws SHDRCException, JSONException, IOException
	{	
		ModelAndView modelAndView=null;
		...
		try{
			modelAndView = new ModelAndView();
			UserInfo.hasValidReportAccess(ShdrcConstants.Role.DIM);
			modelAndView.setViewName("dimIndicatorZone");
			...
			modelAndView.addObject("monthsList", Util.monthsList);
	        List<String> IndicatorCategoryList=dimReportManager.getIndicatorCategories(directorateId);
	      ...
	      //current year is from year ,to year and current month is from month,to month
	        JSONArray indPvtStateData=dimReportManager.getIndicatorPvtStateData(directorateId,indicatorCategory,maxMonth,maxYear,maxMonth,maxYear,userName);
	        ...
	        if(indPvtStateData.length() != 0){
		        ...
		        List<String> generalCategoryList=dimReportManager.getGeneralCategory(directorateId,indicators);
		        ...
		        JSONArray indPvtDistData=dimReportManager.getIndicatorPvtDistrictData(directorateId, indicatorCategory, indicators, generalCategory, maxMonth, maxYear, maxMonth, maxYear, userName);
		        ...
		        JSONArray indPvtInstData=dimReportManager.getIndicatorPvtInstitutionData(directorateId,indicatorCategory,indicators,generalCategory,district,maxMonth,maxYear,maxMonth,maxYear,userName);
	...
	@RequestMapping(value="/dimOnSearch", method=RequestMethod.POST)
	public @ResponseBody void dimGetIndicatorData(HttpServletRequest request,HttpServletResponse response) throws SHDRCException, JSONException, IOException{
        int directorateId=0;
        String userName=null;
        int fromYear=0;
        int toYear=0;
        ...
        try{
	        ...
	        fromMonth = fromMonth.substring(0, 3);
	        toMonth = toMonth.substring(0, 3);
	        JSONArray indPvtStateData=dimReportManager.getIndicatorPvtStateData(directorateId,indicatorCategory,fromMonth,fromYear,toMonth,toYear,userName);
	        ...
	        if(indPvtStateData.length() != 0){
		        ...
		        JSONArray indPvtDistData=dimReportManager.getIndicatorPvtDistrictData(directorateId, indicatorCategory, indicators,generalCategory, fromMonth, fromYear, toMonth, toYear, userName);
		        data.put("indPvtDistData", indPvtDistData);
		        if(indPvtDistData.length() != 0){
			        JSONObject districtObj=indPvtDistData.getJSONObject(0);
			        district=districtObj.get("District").toString();
			        data.put("selectedDist", district);
			        JSONArray indPvtInstData=dimReportManager.getIndicatorPvtInstitutionData(directorateId,indicatorCategory,indicators,generalCategory,district,fromMonth,fromYear,toMonth,toYear,userName);
	...
	@RequestMapping(value="/dimFreeHandZone", method=RequestMethod.GET)
	public ModelAndView FreeHandZone(HttpServletRequest request) throws SHDRCException, JSONException, IOException{
		 int directorateId=Integer.parseInt(request.getParameter("directorateId"));		
		 ModelAndView modelAndView=new ModelAndView();
		 UserInfo.hasValidReportAccess(ShdrcConstants.Role.DIM);
		 List indCategory=dimReportManager.getFreeHandZoneIndCategory(directorateId);
		 List<CommonStringList> indNamesByCategory=dimReportManager.getFreeHandZoneIndNamesByCategory(directorateId,String.valueOf(indCategory.get(0)));
		 List indYearByNameandCate=dimReportManager.getIndYearByNameandCategory(directorateId,String.valueOf(indCategory.get(0)),String.valueOf(indNamesByCategory.get(0).getId()));
		 JSONArray indJsonArray=dimReportManager.getFreeHandZoneData(directorateId,String.valueOf(indCategory.get(0)),String.valueOf(indNamesByCategory.get(0).getId()),Integer.parseInt(String.valueOf(indYearByNameandCate.get(0))));
		 modelAndView.addObject("indJsonArray", indJsonArray);
	...
	@RequestMapping(value="/dimOnCategoryChangeSearch", method=RequestMethod.POST)
	public  @ResponseBody void onCategoryChangeSearch(HttpServletRequest request,HttpServletResponse response) throws SHDRCException, JSONException, IOException{
		 ...
		 PrintWriter out=null;
			out = response.getWriter();
	     List<CommonStringList> indNamesByCategory=dimReportManager.getFreeHandZoneIndNamesByCategory(directorateId,indicatorCategory);
	     String json=new Gson().toJson(indNamesByCategory);  
	     out.println(json);
	}
	@RequestMapping(value="/dimOnIndicatorNameChangeSearch", method=RequestMethod.POST)
	public  @ResponseBody void onIndicatorNameChangeSearch(HttpServletRequest request,HttpServletResponse response) throws SHDRCException, JSONException, IOException{
		 ...
		 PrintWriter out=null;
			out = response.getWriter();
		 List indYearByNameandCate=dimReportManager.getIndYearByNameandCategory(directorateId,indicatorCategory,indicatorName);
		 String json=new Gson().toJson(indYearByNameandCate);  
	     out.println(json);
	}
	@RequestMapping(value="/dimFreeHandZoneBySearch", method=RequestMethod.POST)
	public  @ResponseBody String ShowFreeHandZoneBySearcht(HttpServletRequest request,HttpServletResponse response) throws SHDRCException, JSONException, IOException{
		 int directorateId=Integer.parseInt(request.getParameter("directorateId"));	
		  ...
		  JSONObject object=new JSONObject();      	
	 	  JSONArray indJsonArray=dimReportManager.getFreeHandZoneData(directorateId,indicatorCategory,indCategoryName,Integer.parseInt(year));
	...
	@RequestMapping(value="/dimDistrictData", method=RequestMethod.POST)
	public @ResponseBody void dimGetdistrictData(HttpServletRequest request,HttpServletResponse response) throws SHDRCException, JSONException, IOException{
        int directorateId=0;
        String userName=null;
        int fromYear=0;
        int toYear=0;
        ...
        fromMonth = fromMonth.substring(0, 3);
        toMonth = toMonth.substring(0, 3);
        List<String> generalCategoryList=dimReportManager.getGeneralCategory(directorateId,indicator);
        data.put("generalCategoryList", generalCategoryList);
        generalCategory=generalCategoryList.get(0);
        data.put("generalCategory", generalCategory);
        JSONArray indPvtDistData=dimReportManager.getIndicatorPvtDistrictData(directorateId,category,indicator,generalCategory,fromMonth,fromYear,toMonth,toYear,userName);        
        data.put("indPvtDistData", indPvtDistData);
        if(indPvtDistData.length() != 0){
	        JSONObject dtObj=indPvtDistData.getJSONObject(0);
	        district=dtObj.get("District").toString();
	        data.put("district", district);  
	        JSONArray indPvtInstData=dimReportManager.getIndicatorPvtInstitutionData(directorateId,category,indicator,generalCategory,district,fromMonth,fromYear,toMonth,toYear,userName);
	        data.put("indPvtInstData", indPvtInstData);
        } 
        out.println(data);
        }finally{
	...
	@RequestMapping(value="/dimOnTabChange", method=RequestMethod.POST)
	public @ResponseBody void dimOnTabChange(HttpServletRequest request,HttpServletResponse response) throws SHDRCException, JSONException, IOException{
        int directorateId=0;
        String userName=null;
        int fromYear=0;
        int toYear=0;
        ...
        toMonth = toMonth.substring(0, 3);
        data.put("generalCategory", generalCategory);  
        JSONArray indPvtDistData=dimReportManager.getIndicatorPvtDistrictData(directorateId,indicatorCategory,indicator,generalCategory,fromMonth,fromYear,toMonth,toYear,userName);        
        data.put("indPvtDistData", indPvtDistData);
        if(indPvtDistData.length() != 0){
	        JSONObject districtObj=indPvtDistData.getJSONObject(0);
	        District=districtObj.get("District").toString();
	        data.put("District", District);  
	        JSONArray indPvtInstData=dimReportManager.getIndicatorPvtInstitutionData(directorateId,indicatorCategory,indicator,generalCategory,District,fromMonth,fromYear,toMonth,toYear,userName);
	        data.put("indPvtInstData", indPvtInstData);
        } 
        out.println(data);
        }finally{
	...
	@RequestMapping(value="/dimInstitutionData", method=RequestMethod.POST)
	public @ResponseBody void dimGetInstitutionData(HttpServletRequest request,HttpServletResponse response) throws SHDRCException, JSONException, IOException{
        int directorateId=0;
        String userName=null;
        int fromYear=0;
        int toYear=0;
	...
	@RequestMapping(value="/dimReportForDistrict", method=RequestMethod.POST)
	public  @ResponseBody String ShowDistrictReport(HttpServletRequest request) throws SHDRCException, JSONException, IOException{		
	      ...
	      JSONObject object=new JSONObject();
	    	  JSONArray jsnArray=dimReportManager.getDistrictwiseIndicaotrDetails(directorateID, indicatorCategory,indicatorName, year, indMonth, loggedUser);
	    	  request.setAttribute("indicatorDetailsforDistrict", jsnArray);
		      object.put("indicatorDetailsforDistrict",jsnArray);
	      return object.toString();
	}
	@RequestMapping(value="/dimReportForInstitution", method=RequestMethod.POST)
	public  @ResponseBody String ShowInstitutionReport(HttpServletRequest request) throws SHDRCException, JSONException, IOException{	
	      ...
	      JSONObject object=new JSONObject();
	    	  JSONArray jsnArray=dimReportManager.getInstitutionwiseIndicaotrDetails(directorateID, indicatorCategory,indicatorName,districtName, year, indMonth, loggedUser);
	    	  object.put("indicatorDetailsforDistrict",jsnArray);
	      return object.toString();
	}    
	@RequestMapping(value="/dimSearchIndicatorList", method=RequestMethod.POST)
	public ModelAndView  searchIndicatorListByFilter(HttpServletRequest request,HttpServletResponse response) throws SHDRCException, JSONException, IOException{	    		
		...
		String loggedUser=UserInfo.getLoggedInUserName();    		
		JSONArray indJsonArray=dimReportManager.getDIMIndicatorList(directorateId, indicatorFrequency, Integer.parseInt(indicatorYer), indicatorMnth, loggedUser);  		
		...
		modelView.setViewName("dimDashboardZone");
    	return modelView;
	} 
}
